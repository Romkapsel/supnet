...
- **Industri-fanen** (`jita/industry.html`): produksjonsmarginer for T1-varer i Ylandoki → Jita. Formler i `jita/scripts/industry.py` (testet av `test_industry.py`), robot i `jita/scripts/ingest_industry.py` (Actions-jobb `industry`, daglig 05:40 UTC), tabeller i `jita/sql/005_industry.sql`. Brief: `jita/industri-brief.md`. Steg 2 (mining) er ikke bygget.
