...
```
score = (antall × netto per enhet) / (1 + dager til fylling kjøp + dager til fylling salg)
...
**Downtime:** daglig downtime 11:00–11:15 **UTC** = 13:00–13:15 norsk sommertid (rettet 16. sept 2026; v3 hadde tidssonen feil vei). Alle cron-tider er UTC. Timesjobben kjører :23; roboten kaller `/status/` først og avbryter (uten feil-varsel) hvis serveren er nede. UI viser en advarsel mellom 10:55 og 11:20 UTC: «Ikke legg ordrer nå.»
